...
os.makedirs(os.path.join(MEDIA_CACHE_DIR, "background"), exist_ok=True)
os.makedirs(os.path.join(MEDIA_CACHE_DIR, "mute_video"), exist_ok=True)
...
app.mount("/user_videos", StaticFiles(directory=USER_VIDEOS_DIR), name="user_videos")
app.mount("/user_dubbings", StaticFiles(directory=USER_DUBBINGS_DIR), name="user_dubbings")
